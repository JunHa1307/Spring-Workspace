...
public class BeforeTest {
	...
	public void logService(JoinPoint jp) { // JoinPoint 인터페이스는 항상 첫 번째 매개변수로 작성되어야한다
		StringBuilder sb = new StringBuilder();
		sb.append("===================================================\n");
		
		// start : 실행된 클래스명 - 실행한 메서드
