 ...
 * 
 */
// 페이지 로딩 완료시 채팅창을 제일 밑으로 내리기(즉시 실행 함수(IIFE) => 속도가 빠르고, 변수명 중복문제 해결)
(
	function(){
...
// WebsocketHandler에서 sendMessage라는 함수가 호출되었을 때를 캐치하는 이벤트핸들러
chattingSock.onmessage = function(e){
	...
	if(userNo == chatMessage.userNo) { // 내가 쓴거
		li.append(span,p);
